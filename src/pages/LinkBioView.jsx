                ...
                <Card className="bg-white/95 backdrop-blur-sm border-none shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 overflow-hidden group">
                  ...
                  <div className="p-6">
                    <div className="flex items-start gap-4">
                      {/* Logo da Petição - Sobreposto ao Banner */}
                      {petition.logo_url && (
                        <div className="shrink-0 -mt-16 relative z-10">
                          <div className="w-20 h-20 rounded-2xl overflow-hidden shadow-2xl border-4 border-white group-hover:border-opacity-80 transition-all">
                            <img
