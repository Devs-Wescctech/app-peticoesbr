      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-12">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <Button
              size="lg"
              onClick={() => navigate(createPageUrl("CreateEmailCampaign"))}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 -mt-8 relative z-10 pb-8">
        ...
        <Card className="p-6 shadow-xl border-none bg-white/80 backdrop-blur-xl mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            {/* Modern Tab Filters com cores azuis */}
              ...
              <Card key={campaign.id} className="border-none shadow-lg hover:shadow-xl transition-all">
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  {campaign.sender_email && (
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Remetente:</p>
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button
                      ...
                      onClick={() => navigate(createPageUrl(`CreateEmailCampaign?id=${campaign.id}`))}
                    >
            ...
            <div className="flex gap-2">
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                <Button
                  ...
                  className={`rounded-xl ${currentPage === page ? "bg-gradient-to-r from-blue-500 to-indigo-600" : ""}`}
                >
                  {page}
                </Button>
              ))}
          ...
          <Card className="border-none shadow-lg">
            <CardContent className="p-16 text-center">
              ...
              <p className="text-gray-600 mb-6">
                {searchTerm ? 'Tente ajustar os filtros de busca' : 'Crie sua primeira campanha de Email'}
              </p>
              {!searchTerm && (
                <Button
                  onClick={() => navigate(createPageUrl("CreateEmailCampaign"))}
                  className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 font-semibold shadow-lg"
                >
